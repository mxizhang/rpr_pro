...
class E07202Spider(Spider):
    name = "e_07202"
    allowed_domains = ["narrpr.com"]
    start_urls = ["https://www.narrpr.com/"]
    ...
    def parse(self, response):
        ...
        el = self.driver.find_element_by_xpath('//a[@href="/Sales/SalesSearch?countyId=3"]')
        el.click()
